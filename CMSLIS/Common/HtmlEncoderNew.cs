...
namespace EDS.Common
{
	/// <summary>
	/// HTML 4 Entity coding routines
	/// </summary>
	public class HtmlEncoderNew
	{
        /// <summary>
        /// Encode Unicode to ISO8859
        /// </summary>
        /// <param name="value">string input code unincode</param>
        /// <returns>string output iso8859 code</returns>
        ...
        /// <summary>
        /// Decode ISO8859 to Unicode
        /// </summary>
        /// <param name="value">string input code iso 8859</param>
        /// <returns>string output unicode</returns>
			...
			while( c != -1 )
			{
                try
                {
                    ...
                    if (c == '&')
                    {
                        ...
                        // Rewrite by manhlq@gmail.com, 13/01/2010.
                        do
                        {
                            token.Append((char)c);
                            c = reader.Read();
