document.addEventListener("keydown", function (event) {
    if (event.keyCode == 112) {
        var url = document.getElementById("ListTemplateResultExaminationNew").href;
            ...
            buttons: {
                specialKey: {
                    ...
                    action: function () {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "/CatalogSystem/ListTemplateResultExaminationDelete",
            ...
            buttons: {
                specialKey: {
                    ...
                    action: function () {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "/CatalogSystem/ListTemplateResultExaminationPublic",
                            data: JSON.stringify(selectedIDs),
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            headers: {
