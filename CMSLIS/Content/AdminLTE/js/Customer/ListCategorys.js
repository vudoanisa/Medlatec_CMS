document.addEventListener("keydown", function (event) {
    if (event.keyCode == 112) {
        ConfirmAdd();
        // var url = document.getElementById("MenuAdd").href;
...
function ConfirmAdd() {
    var selectedValue = parentID.value;
    window.location.href = "/CatalogSystem/CategorysAdd?cateParrent=" + selectedValue;
    return true;
}
            ...
            buttons: {
                specialKey: {
                    ...
                    action: function () {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "/CatalogSystem/ListCategorysDelete",
            ...
            buttons: {
                specialKey: {
                    ...
                    action: function () {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "/CatalogSystem/ListCategorysPublic",
                            data: JSON.stringify(selectedIDs),
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            headers: {
