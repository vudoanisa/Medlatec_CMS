...
$(document).ready(function () {
    ...
    $(":button").click(function (event) {
        ...
        if ($(this).prop("id") == "SaveREFUNDStore1") {
            check = true;
        }
    ...
    $("#CMS_MEDICINE_EXPORT_STORE_CODE").keydown(function () {
        var key_enter = 13; // 13 = Enter
        if (key_enter == event.keyCode) {
            event.keyCode = 0;

            window.location.href = "/pharmacyStore/REFUNDStoreAdd?EXPORT_STORE_ID=" + $("#CMS_MEDICINE_EXPORT_STORE_CODE").val();
        }
    });
