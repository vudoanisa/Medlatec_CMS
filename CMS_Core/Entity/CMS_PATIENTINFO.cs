...
{
    [Serializable]
    public class CMS_PATIENTINFO : IValidatableObject
    {
        ...
        public String WEIRDO_NOTE { get; set; }
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            {
                //    results.Add(new ValidationResult("Mời bạn nhập ngày CMT"));
                //}
                //else
                //{
                DateTime dateTime = new DateTime();
            ...
            if (weight < 0)
            {
                results.Add(new ValidationResult("Cân nặng bệnh nhân không được nhỏ hơn 0kg"));
            }

            if (weight > 200)
            {
                results.Add(new ValidationResult("Cân nặng bệnh nhân không được lớn hơn 200kg"));
            }
